...
void protobuf_AssignDesc_protobuf_2fdata_2eproto() {
  ...
  DataLabel_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(DataLabel));
  Packet_descriptor_ = file->message_type(4);
...
void protobuf_AddDesc_protobuf_2fdata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "nels\030\002 \003(\0132\014.DataChannel\022\037\n\013data_groups\030"
    ...
    "TATYPE_FLOAT\020\002\022\026\n\022VB_DATATYPE_VECTOR\020\003", 758);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_data_labels;
        if (input->ExpectTag(42)) goto parse_console_output;
        break;
      }
